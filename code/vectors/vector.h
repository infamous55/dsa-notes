...
public:
  ...
  void insert_at(int index, T value); // inserts the value at the given index, shifts all other values to the right
  ...
  int find(T value) const; // returns the index of the value, or -1 if it is not found
